...
pygame.display.set_caption('Programming language')
...
class Player():
	...
	def update(self, game_over):
		...
		if game_over == 0:
			...
			draw_text('GAME OVER!', font, blue, (screen_width // 2) - 140, (screen_height // 2) - 70)
			self.rect.y -= 5
	...
	if main_menu == True:
		...
		if game_over == 0:
			...
			if pygame.sprite.spritecollide(player, coin_group, True):
				score += 1
				coin_fx.play()
			draw_text('Score: ' + str(score), font_score, white, tile_size + 20, 50)
		...
		if game_over == 1:
			...
			if level <= max_levels:
				...
				draw_text('YOU WIN!', font, blue, (screen_width // 2) - 120, (screen_height // 2) - 70)
				if restart_button.draw():
